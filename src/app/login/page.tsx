...
/**
 * Login Page - Professional Blue Theme
 *
 * SCALE: Replace with Clerk's SignIn component:
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 space-y-6 border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-center text-xs text-gray-500 dark:text-gray-400">
            Secure authentication for generating and publishing<br />location/service pages to WordPress
          </p>
        </div>
      </div>
    </div>
